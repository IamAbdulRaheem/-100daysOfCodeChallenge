...
// Parameters
function parameters(from:string, text:string){
    console.log(`${from}: ${text}`)
}
parameters('Abdul Raheem', 'Hello!');

// Default Parameters
function defaultParameters(from:string, text: string= "No text given!"){
    console.log(`${from}: ${text}`);
}
...
function alternativeDefaultParameters(text:string){
    if (text=== undefined) {
        text= "Empty message"
    }
    console.log(text);
...
function defaultParametersWithOR(text:string){
