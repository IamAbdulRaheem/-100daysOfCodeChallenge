...
function findingPositionOfSubstring(substr:string) {
...
function checkPresence(sentence:any):boolean {
...
console.log(extractingSubstring("My name is Abdul Raheem. I am currently enrolled in governor sindh IT programme."));  // It will extract the value of substring that starts from 0 and ends on 25